...
class EditSelfManage extends Component {
    ...
    componentDidMount() {
        ...
        console.log(state)
        if (state == undefined) {
            return this.props.history.push('/admin-self-manage/')
        }
            ...
            <ContentWrapper>
                <div className="content-heading">
                    ...
                    <div className="flex-row">
                        ...
                        <Button onClick={this.ViewAllAdminUsers} style={this.AddActionButtonStyle} className="btn-pill-right mr-2">View Account Management</Button>
