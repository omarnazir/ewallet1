...
class AddRegistar extends Component {
    ...
    handleComplexChange=event=>{
        ...
        if([event.target.name]=="regionId"){
            ...
            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,districtId:0}}); 
            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,wardId:0}});
            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,villageId:0}});

            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,regionId:[event.target.value]}});
        ...
        if([event.target.name]=="districtId"){
            ...
            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,districtId:[event.target.value]}})
        }
        if([event.target.name]=="wardId"){
            this.getAllVillagesByWard([event.target.value]);
            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,villageId:0}})

            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,wardId:[event.target.value]}})
        }

        if(event.target.name=="villageId"){
            this.setState({formAddRegistrar:{...this.state.formAddRegistrar,villageId:[event.target.value]}})
        }
    }
                                ...
                                <Row>
                                    <Col md={3}>
                                        <div className="form-group">
                                            ...
                                            <select name="regionId" className="form-control" value={this.state.formAddRegistrar.regionId} onChange={this.handleComplexChange}>
                                    ...
                                    <Col md={3}>
                                        <div className="form-group">
                                            ...
                                            <select name="districtId" className="form-control" value={this.state.formAddRegistrar.districtId} onChange={this.handleComplexChange}>
                                                <option value="0">-- Select --</option>
                                                {
                                    ...
                                    <Col md={3}>
                                        <div className="form-group">
                                            ...
                                            <select name="wardId" className="form-control" value={this.state.formAddRegistrar.wardId} onChange={this.handleComplexChange}>
                                                <option value="0">-- Select --</option>
                                                {
                                    ...
                                    <Col md={3}>
                                        <div className="form-group">
                                            ...
                                            <select name="villageId" className="form-control" value={this.state.formAddRegistrar.villageId} onChange={this.handleComplexChange}>
                                                <option value="0">-- Select --</option>
                                                {
